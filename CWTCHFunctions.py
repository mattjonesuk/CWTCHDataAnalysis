        ...
        for phaseNo, phase in enumerate(phaseData):
            ...
            if len(block) == 1:
                ...
                for trialNo, trial in enumerate(trials):
                        ...
                        # error in this case and replaces the data with NaN.
                        if 'clicked' in trial.keys():
                            clicked = trial['clicked'][0]
                            rt = trial['clicked'][1]
                            correct = corrPosition == clicked
                        else:
                            clicked = float('nan')
                            rt = float('nan')
                            correct = float('nan')
                        ...
                        # This statement is added because only the probe data
                        # has a 'kind' field.
                        if 'kind' in trial.keys():
                        ...
                        entry['trialStartTime'] = trialStartTime
                        entry['trialEndTime'] = trialEndTime
                        entry['corrPosition'] = corrPosition
                        entry['rt'] = rt
